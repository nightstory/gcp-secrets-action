 ...
 *
 * Copied from: https://github.com/google-github-actions/get-secretmanager-secrets/blob/main/src/client.ts
 * Changes: remove deprecation message
 */
...
const userAgent = `google-github-actions:get-secretmanager-secrets/0.5.3`;
 ...
 * @returns GoogleSecretManagerClient
 */
export class GoogleSecretManagerClient {
  ...
  async accessSecret(ref: string): Promise<string> {
    ...
    try {
      ...
      const value = fromBase64(b64data)
